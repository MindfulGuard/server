...
IF user_id IS NULL THEN
    ...
    INSERT INTO u_users VALUES (gen_random_uuid (),$1,$3,$4,current_timeu,$2,False) RETURNING u_id INTO user_id_insert;
...
--
-- Name: update_item(character varying, uuid, uuid, character varying, json, character varying, character varying[]); Type: FUNCTION; Schema: public; Owner: mindfulguard
--
...
ALTER FUNCTION public.update_item(token character varying, safe_id uuid, item_id uuid, title character varying, item json, notes character varying, tags character varying[]) OWNER TO mindfulguard;
...
ALTER FUNCTION public.update_secret_string(old_secret_string character varying, new_secret_string character varying, token character varying) OWNER TO mindfulguard;
...
--
-- Name: c_codes e_ecodes_pkey; Type: CONSTRAINT; Schema: public; Owner: mindfulguard
--
...
--
-- Name: r_records r_login_r_s_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: mindfulguard
--
