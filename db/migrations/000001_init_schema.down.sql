...
DROP FUNCTION public.update_token_info (
    character varying, character varying, inet
);
DROP FUNCTION public.create_safe (
    character varying, character varying, character varying
);
DROP FUNCTION public.update_safe (
...
DROP FUNCTION public.update_item (
    character varying,
    uuid,
    uuid,
    character varying,
...
DROP FUNCTION public.move_item_to_new_safe (
    character varying, uuid, uuid, uuid
);
...
DROP FUNCTION public.update_c_codes_code (
    character varying, character varying, integer []
);
DROP FUNCTION public.update_c_codes_code (
    character varying, character varying, character varying
);
DROP FUNCTION public.update_secret_string (
    character varying, character varying, character varying
);
